...
def main():
    ...
    parser.add_argument("--diff_loss", type=float, default=0.02)
    ...
    parser.add_argument("--lambda_0", type=float, default=0.3, help="weight of coarse-grain intent contrastive learning task")
