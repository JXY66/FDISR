...
class UNet1D(nn.Module):
    ...
    def reverse_denoise(self, x_t, t):
        ...
        x_t_with_time = x_t + time_embedding  
...
class SASRecModel(nn.Module):
    ...
    def forward(self, input_ids):
        ...
        sequence_emb = sequence_emb + aggregated_intent  
        ...
        for expert in self.experts:
            ...
            expert_outputs.append(expert_output[-1])


        expert_outputs = torch.stack(expert_outputs, dim=-1)  # (batch_size, seq_len, hidden_size, num_experts)
        sequence_output = torch.einsum('bshn,bse->bsh', expert_outputs, router_probs)  
